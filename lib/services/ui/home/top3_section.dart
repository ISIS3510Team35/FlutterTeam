...
class Top3 extends StatefulWidget {
  const Top3({Key? key, required this.plateBloc}) : super(key: key);

  final PlateBloc plateBloc;

  @override
  _Top3State createState() => _Top3State();
}
...
class _Top3State extends State<Top3> {
  ...
  void initState() {
    super.initState();
    widget.plateBloc.fetchTop3Plates();
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder(
            stream: widget.plateBloc.top3Plates,
