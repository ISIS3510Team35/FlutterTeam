                  ...
                  children: [
                    IconButton(
                      icon: const Icon(Icons.arrow_back,
                          size: 30, color: Color.fromARGB(255, 146, 146, 146)),
                      onPressed: () {
                        Navigator.pop(context);
                      },
                    ),
                    const Icon(Icons.account_circle,
                        size: 80, color: Color.fromARGB(255, 146, 146, 146)),
                    IconButton(
                        onPressed: () {
                          if (!edit) {
                            setState(() {
                        ...
                        icon: Icon(
                          !edit ? Icons.edit : Icons.delete_forever,
                          size: 30,
                          color: !edit
                ...
                SizedBox(
                    ...
                    child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            if (!edit) {
                              number.text = snapshot.data!.getString('number')!;
                              ...
                              edit
                                  ? Column(children: [
                                      ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            await _userBloc.changeUserInfo(
                                                user.text, number.text);
                                            setState(() {
                                              edit = !edit;
                                            });
                                          },
                            ...
                            return const Text(
                                'No es posible acceder a tu cuenta, intenta de nuevo más tarde');
                          }
                        })),
              ],
            ),
